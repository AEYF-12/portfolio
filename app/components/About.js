            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-12 max-w-6xl w-full z-10">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-8">
                        Hi, Iam Rahul Son Boro, a passionate Computer Science Engineering student at Central Institute of Technology Kokrajhar, currently in my 3rd year. With a strong foundation in technology and a drive for innovation, I love exploring the world of coding, problem-solving, and software development.
                        ...
                        When Iam not coding, you will find me learning new tech trends, collaborating with peers, or working on personal projects. Iam eager to connect, learn, and take on new challenges—let us build something great together!
                    </p>
                ...
                <div className="w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-[400px] lg:h-[400px] rounded-full overflow-hidden shadow-xl">
                    <Image
                        src="/compute.jpg"  // Move the image to the /public folder
